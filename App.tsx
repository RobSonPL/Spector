...
const MetricBar: React.FC<{ label: string; value: number; max: number; color: string; prefix?: string; suffix?: string }> = ({ label, value, max, color, prefix = '', suffix = '' }) => {
  ...
  return (
    <div className="mb-4">
      ...
      <div className="h-2 bg-neutral-100 dark:bg-neutral-900 rounded-full overflow-hidden border border-neutral-200 dark:border-neutral-800 shadow-inner">
...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex bg-neutral-50 dark:bg-black transition-colors duration-700 font-sans">
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 lg:p-20 relative overflow-hidden">
